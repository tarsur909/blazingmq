...
__out != 0 && ((value == OptionType::e_UNDEFINED ==> __out == "UNDEFINED") && (value == OptionType::e_SUB_QUEUE_IDS_OLD ==> __out == "SUB_QUEUE_IDS_OLD") && (value == OptionType::e_MSG_GROUP_ID ==> __out == "MSG_GROUP_ID") && (value == OptionType::e_SUB_QUEUE_INFOS ==> __out == "SUB_QUEUE_INFOS") && (value != OptionType::e_UNDEFINED && value != OptionType::e_SUB_QUEUE_IDS_OLD && value != OptionType::e_MSG_GROUP_ID && value != OptionType::e_SUB_QUEUE_INFOS ==> __out == "(* UNKNOWN *)"))
...
(__out == true ==> (out != 0 && ((*out == PutHeaderFlags::e_ACK_REQUESTED) || (*out == PutHeaderFlags::e_MESSAGE_PROPERTIES) || (*out == PutHeaderFlags::e_UNUSED3) || (*out == PutHeaderFlags::e_UNUSED4)))) && (__out == false ==> *out == old_out)
...
__out == &stream && (flags & PutHeaderFlags::e_ACK_REQUESTED ==> __out->rdbuf()->str().find(PutHeaderFlags::toAscii(PutHeaderFlags::e_ACK_REQUESTED)) != std::string::npos) && (flags & PutHeaderFlags::e_MESSAGE_PROPERTIES ==> __out->rdbuf()->str().find(PutHeaderFlags::toAscii(PutHeaderFlags::e_MESSAGE_PROPERTIES)) != std::string::npos) && (flags & PutHeaderFlags::e_UNUSED3 ==> __out->rdbuf()->str().find(PutHeaderFlags::toAscii(PutHeaderFlags::e_UNUSED3)) != std::string::npos) && (flags & PutHeaderFlags::e_UNUSED4 ==> __out->rdbuf()->str().find(PutHeaderFlags::toAscii(PutHeaderFlags::e_UNUSED4)) != std::string::npos)
...
__out != 0 && ((value == PushHeaderFlags::Enum::e_IMPLICIT_PAYLOAD ==> __out == "IMPLICIT_PAYLOAD") || (value == PushHeaderFlags::Enum::e_MESSAGE_PROPERTIES ==> __out == "MESSAGE_PROPERTIES") || (value == PushHeaderFlags::Enum::e_OUT_OF_ORDER ==> __out == "OUT_OF_ORDER") || (value == PushHeaderFlags::Enum::e_UNUSED4 ==> __out == "UNUSED4") || (__out == "(* UNKNOWN *)"))
...
(__out == true ==> (out != 0 && (out ↦ PushHeaderFlags::Enum))) && (__out == false ==> (out ↦ old_out))
...
(__out == 0 ==> (out != 0)) && (__out == -1 ==> EXISTS(0, str.size(), i, str.find("Invalid flag(s)") != std::string::npos))
...
__out == stream && (__out << StorageMessageType::toAscii(value)) && (spacesPerLevel >= 0 ==> (__out << std::string("\n")))
...
(__out == true ==> (*out == StorageHeaderFlags::e_RECEIPT_REQUESTED || *out == StorageHeaderFlags::e_UNUSED2 || *out == StorageHeaderFlags::e_UNUSED3 || *out == StorageHeaderFlags::e_UNUSED4)) && (__out == false ==> *out == old_out)
