...
// ensures: (__out == true ==> ((out ↦ PutHeaderFlags::e_ACK_REQUESTED) || (out ↦ PutHeaderFlags::e_MESSAGE_PROPERTIES) || (out ↦ PutHeaderFlags::e_UNUSED3) || (out ↦ PutHeaderFlags::e_UNUSED4))) && (__out == false ==> true)
...
// requires: true
// ensures: (__out == false ==> (isSet(flags, PutHeaderFlags::e_UNUSED3) || isSet(flags, PutHeaderFlags::e_UNUSED4))) && (__out == true ==> !(isSet(flags, PutHeaderFlags::e_UNUSED3) || isSet(flags, PutHeaderFlags::e_UNUSED4)))
...
// requires: true
// ensures: (__out == false ==> isSet(flags, PushHeaderFlags::e_UNUSED4)) && (__out == true ==> !isSet(flags, PushHeaderFlags::e_UNUSED4))
...
// requires: out != 0
// ensures: (__out == true ==> ((out ↦ StorageHeaderFlags::e_RECEIPT_REQUESTED) || (out ↦ StorageHeaderFlags::e_UNUSED2) || (out ↦ StorageHeaderFlags::e_UNUSED3) || (out ↦ StorageHeaderFlags::e_UNUSED4))) && (__out == false ==> true)
...
// requires: true
// ensures: (__out == false ==> (isSet(flags, StorageHeaderFlags::e_UNUSED2) || isSet(flags, StorageHeaderFlags::e_UNUSED3) || isSet(flags, StorageHeaderFlags::e_UNUSED4))) && (__out == true ==> !(isSet(flags, StorageHeaderFlags::e_UNUSED2) || isSet(flags, StorageHeaderFlags::e_UNUSED3) || isSet(flags, StorageHeaderFlags::e_UNUSED4)))
