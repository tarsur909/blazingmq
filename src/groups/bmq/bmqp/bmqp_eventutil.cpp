...
{
    re// requires: true
// ensures: (__out == true) ==> ((optionsView.find(OptionType::e_SUB_QUEUE_INFOS) != optionsView.end()) || (optionsView.find(OptionType::e_SUB_QUEUE_IDS_OLD) != optionsView.end())) && (__out == false) ==> ((optionsView.find(OptionType::e_SUB_QUEUE_INFOS) == optionsView.end()) && (optionsView.find(OptionType::e_SUB_QUEUE_IDS_OLD) == optionsView.end()))
