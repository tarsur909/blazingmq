...
// ensures: (context.d_validationOnly == false) && (d_isCompiled == true) && (__out == context.lastError()) && (context.hasError() ==> d_expression == nullptr) && (!context.hasError() ==> d_expression == context.d_expression)
or()
{
    // NOTHING
}
