...
// FUNCTIONS
(__out == true) ==> ((context->isDeleted() && (valueType == bmqst::StatContext::e_TOTAL_VALUE)) || (bmqst::StatUtil::value(context->value(valueType, 0), 0) > 0)) && (__out == false) ==> !((context->isDeleted() && (valueType == bmqst::StatContext::e_TOTAL_VALUE)) || (bmqst::StatUtil::value(context->value(valueType, 0), 0) > 0))
