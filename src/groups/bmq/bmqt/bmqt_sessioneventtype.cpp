...
(__out == "UNDEFINED" || __out == "CONNECTED" || __out == "DISCONNECTED" || __out == "CONNECTION_LOST" || __out == "RECONNECTED" || __out == "STATE_RESTORED" || __out == "CONNECTION_TIMEOUT" || __out == "QUEUE_OPEN_RESULT" || __out == "QUEUE_REOPEN_RESULT" || __out == "QUEUE_CLOSE_RESULT" || __out == "SLOWCONSUMER_NORMAL" || __out == "SLOWCONSUMER_HIGHWATERMARK" || __out == "QUEUE_CONFIGURE_RESULT" || __out == "HOST_UNHEALTHY" || __out == "HOST_HEALTH_RESTORED" || __out == "QUEUE_SUSPENDED" || __out == "QUEUE_RESUMED" || __out == "ERROR" || __out == "TIMEOUT" || __out == "CANCELED" || __out == "(* UNKNOWN *)")
