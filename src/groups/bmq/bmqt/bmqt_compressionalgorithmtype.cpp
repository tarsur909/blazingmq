...
// ensures: (__out == true ==> ((out ↦ CompressionAlgorithmType::e_NONE) || (out ↦ CompressionAlgorithmType::e_ZLIB))) && (__out == false ==> !bdlb::String::areEqualCaseless(toAscii(CompressionAlgorithmType::e_NONE), str) && !bdlb::String::areEqualCaseless(toAscii(CompressionAlgorithmType::e_ZLIB), str))
...
// requires: str != 0
// ensures: (__out == true ==> EXISTS(0, 1, dummy, fromAscii(str) == true)) && (__out == false ==> EXISTS(0, 1, dummy, fromAscii(str) == false))
