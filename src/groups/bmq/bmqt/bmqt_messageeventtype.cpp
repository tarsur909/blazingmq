...
// requires: true
// ensures: (value == MessageEventType::e_UNDEFINED ==> __out == "UNDEFINED") && (value == MessageEventType::e_PUT ==> __out == "PUT") && (value == MessageEventType::e_PUSH ==> __out == "PUSH") && (value == MessageEventType::e_ACK ==> __out == "ACK") && (value != MessageEventType::e_UNDEFINED && value != MessageEventType::e_PUT && value != MessageEventType::e_PUSH && value != MessageEventType::e_ACK ==> __out == "(* UNKNOWN *)")
...
// requires: true
// ensures: (__out == true ==> (*out == MessageEventType::e_UNDEFINED || *out == MessageEventType::e_PUT || *out == MessageEventType::e_PUSH || *out == MessageEventType::e_ACK)) && (__out == false ==> *out == old_out)
