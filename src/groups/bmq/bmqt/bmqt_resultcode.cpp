...
__out != 0 && (__out == "SUCCESS" || __out == "UNKNOWN" || __out == "TIMEOUT" || __out == "NOT_CONNECTED" || __out == "CANCELED" || __out == "NOT_SUPPORTED" || __out == "REFUSED" || __out == "INVALID_ARGUMENT" || __out == "NOT_READY" || __out == "ALREADY_IN_PROGRESS" || __out == "INVALID_QUEUE" || __out == "(* UNKNOWN *)")
...
(__out == true ==> ((*out ↦ EventBuilderResult::e_SUCCESS) || (*out ↦ EventBuilderResult::e_UNKNOWN) || (*out ↦ EventBuilderResult::e_QUEUE_INVALID) || (*out ↦ EventBuilderResult::e_QUEUE_READONLY) || (*out ↦ EventBuilderResult::e_MISSING_CORRELATION_ID) || (*out ↦ EventBuilderResult::e_EVENT_TOO_BIG) || (*out ↦ EventBuilderResult::e_PAYLOAD_TOO_BIG) || (*out ↦ EventBuilderResult::e_PAYLOAD_EMPTY) || (*out ↦ EventBuilderResult::e_OPTION_TOO_BIG) || (*out ↦ EventBuilderResult::e_QUEUE_SUSPENDED)) ⋆ true) && (__out == false ==> true)
...
__out == &stream && (__out != nullptr && *__out == stream)
