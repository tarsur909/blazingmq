...
(__out == *this) && (d_realtimeClock ↦ value)
...
(__out.d_realtimeClock ↦ (old_d_realtimeClock + offset)) && (&__out == this)
...
__out.d_monotonicClock ↦ (old_d_monotonicClock + offset)
...
__out.d_highResTimer == (d_highResTimer + offset)
