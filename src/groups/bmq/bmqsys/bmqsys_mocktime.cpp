...
__out.d_realtimeClock == (old___out.d_realtimeClock + offset) ⋆ &__out == this
...
__out.d_monotonicClock ↦ (d_monotonicClock + offset)
...
__out.d_highResTimer == (old_d_highResTimer + offset)
