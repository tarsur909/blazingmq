...
// bmqsys_statmonitorsnapshotrecorder.cpp                             -*-C++-*-
                                        ...
                                        const bsl::string& section) const
{
    ...
    os << d_impl_sp->d_header << "'" << section << "' (Total elapsed: "
       ...
       << "    WALL TIME .....................: "
       << bmqu::PrintUtil::prettyTimeInterval(wallTimeNs);
...
// ACCESSORS
// requires: true
// ensures: __out == bmqsys::Time::highResolutionTimer() - d_impl_sp->d_startTimeNs
