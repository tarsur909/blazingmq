...
// bmqio_resolvingchannelfactory.cpp                                  -*-C++-*-
...
BALL_LOG_SET_NAMESPACE_CATEGORY("BMQIO.RESOLVINGCHANNELFACTORY")
...
// MANIPULATORS
__out.d_resolutionFn.target<void(*)(bsl::string*, const BloombergLP::bmqio::Channel&)>() == value.target<void(*)(bsl::string*, const BloombergLP::bmqio::Channel&)>()
