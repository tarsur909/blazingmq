...
, d_endpointResolveFn(bsl::allocator_arg,
                      basicAllocator,
                      original.d_endpointResolve&__out == this
Fn)
{
    // NOTHING
}
...
{
    d_reconnectIntervalFn = valu__out.d_endpointResolveFn.target<void(bsl::vector<bsl::basic_string<char>>*, const BloombergLP::bmqio::ConnectOptions&)>() == value.target<void(bsl::vector<bsl::basic_string<char>>*, const BloombergLP::bmqio::ConnectOptions&)>()
e;
    return *this;
}
