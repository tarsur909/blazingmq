...
(__out == true ==> (request.choice().isConfigureStreamValue() || request.choice().isConfigureQueueStreamValue())) && (__out == false ==> !(request.choice().isConfigureStreamValue() || request.choice().isConfigureQueueStreamValue()))
BSLA_MAYBE_UNUSED
bool isConfigure(const bmqp_ctrlmsg::ControlMessage& request)
{
    return request.choice().isConfigureStreamValue() ||
...
(__out == true ==> (response.choice().isConfigureStreamResponseValue() || response.choice().isConfigureQueueStreamResponseValue())) && (__out == false ==> !(response.choice().isConfigureStreamResponseValue() || response.choice().isConfigureQueueStreamResponseValue()))
BSLA_MAYBE_UNUSED
...
(__out == true ==> (this->d_owner_p == rhs.d_owner_p)) && (__out == false ==> (this->d_owner_p != rhs.d_owner_p))
