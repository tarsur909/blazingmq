...
/// parsed from the specified `messageTypeStr` and return 0 if succes(__out == rc_SUCCESS ==> (bdlb::String::areEqualCaseless(messageTypeStr, "in") || bdlb::String::areEqualCaseless(messageTypeStr, "out") || bdlb::String::areEqualCaseless(messageTypeStr, "push") || bdlb::String::areEqualCaseless(messageTypeStr, "ack") || bdlb::String::areEqualCaseless(messageTypeStr, "put") || bdlb::String::areEqualCaseless(messageTypeStr, "confirm"))) && (__out == rc_INVALID_MSGTYPE ==> !(bdlb::String::areEqualCaseless(messageTypeStr, "in") || bdlb::String::areEqualCaseless(messageTypeStr, "out") || bdlb::String::areEqualCaseless(messageTypeStr, "push") || bdlb::String::areEqualCaseless(messageTypeStr, "ack") || bdlb::String::areEqualCaseless(messageTypeStr, "put") || bdlb::String::areEqualCaseless(messageTypeStr, "confirm")))
sful,
/// non-zero otherwise.
