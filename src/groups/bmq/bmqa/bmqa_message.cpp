...
const bsl::string& Message::groupId() const
{
    ...
    BSLS_ASSERT_OPT(false && "Invalid raw event type// requires: isInitialized() && d_impl.d_event_p->rawEvent().isPushEvent()
