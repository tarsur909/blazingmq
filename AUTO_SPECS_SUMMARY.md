...
- **src/groups/bmq/bmqeval/bmqeval_simpleevaluator.cpp**
  ...
  - ensures:
    ...
    - `(context.d_validationOnly == false) && (d_isCompiled == true) && (__out == context.lastError()) && (context.hasError() ==> d_expression == nullptr) && (!context.hasError() ==> d_expression == context.d_expression)`
...
- **src/groups/bmq/bmqimp/bmqimp_event.cpp**
  ...
  - ensures:
    ...
    - `__out == *this && (d_queuesBySubscriptionId.find(SubscriptionId(queue->id(), subscriptionId)) != d_queuesBySubscriptionId.end()) && (d_queuesBySubscriptionId.at(SubscriptionId(queue->id(), subscriptionId)) == queue)`
    - `__out == stream && (stream.bad() || stream.good())`
    - `__out.d_type == EventType::e_RAW`
    - `__out.d_type == EventType::e_REQUEST && __out.d_eventCallback == value`
    - `__out.type() == EventType::e_MESSAGE && __out.d_msgEventMode == MessageEventMode::e_READ`
...
- **src/groups/bmq/bmqio/bmqio_channelutil.cpp**
  - requires:
    - `outPacket->length() == 0 && inBlob->length() >= EXISTS(1, inBlob->length() + 1, len, len >= 1)`
    - `true`
  - ensures:
    - `(__out == 0 || __out == -1)`
...
- **src/groups/bmq/bmqp/bmqp_eventutil.cpp**
  ...
  - ensures:
    ...
    - `(__out == true) ==> ((optionsView.find(OptionType::e_SUB_QUEUE_INFOS) != optionsView.end()) || (optionsView.find(OptionType::e_SUB_QUEUE_IDS_OLD) != optionsView.end())) && (__out == false) ==> ((optionsView.find(OptionType::e_SUB_QUEUE_INFOS) == optionsView.end()) && (optionsView.find(OptionType::e_SUB_QUEUE_IDS_OLD) == optionsView.end()))`
...
- **src/groups/bmq/bmqp/bmqp_optionutil.cpp**
  ...
  - ensures:
    ...
    - `__out.type() == OptionType::e_UNDEFINED`
- **src/groups/bmq/bmqp/bmqp_protocol.cpp**
  ...
  - ensures:
    ...
    - `(__out == false ==> ((isSet(flags, PutHeaderFlags::e_UNUSED3) || isSet(flags, PutHeaderFlags::e_UNUSED4)) && SEPFORALL(0, strlen("UNUSED flags are invalid.\n"), i, errorDescription + i ↦ "UNUSED flags are invalid.\n"[i]))) && (__out == true ==> !(isSet(flags, PutHeaderFlags::e_UNUSED3) || isSet(flags, PutHeaderFlags::e_UNUSED4)))`
    - `(__out == false ==> (errorDescription << "UNUSED flags are invalid." && SEPFORALL(0, strlen("UNUSED flags are invalid."), i, errorDescription + i ↦ "UNUSED flags are invalid."[i]))) && (__out == true ==> true)`
    ...
    - `PrintStream(stream, level, spacesPerLevel, OptionType::toAscii(value))`
...
- **src/groups/bmq/bmqt/bmqt_compressionalgorithmtype.cpp**
  - requires:
    ...
    - `true`
  - ensures:
    - `(__out == true ==> ((*out == CompressionAlgorithmType::e_NONE && bdlb::String::areEqualCaseless(toAscii(CompressionAlgorithmType::e_NONE), str)) || (*out == CompressionAlgorithmType::e_ZLIB && bdlb::String::areEqualCaseless(toAscii(CompressionAlgorithmType::e_ZLIB), str)))) && (__out == false ==> !bdlb::String::areEqualCaseless(toAscii(CompressionAlgorithmType::e_NONE), str) && !bdlb::String::areEqualCaseless(toAscii(CompressionAlgorithmType::e_ZLIB), str))`
    - `(__out == true) || (__out == false && SEPFORALL(0, strlen("Error: compressionAlgorithmType must be one of [NONE, ZLIB]\n"), i, stream + i ↦ "Error: compressionAlgorithmType must be one of [NONE, ZLIB]\n"[i]))`
...
- **src/groups/bmq/bmqt/bmqt_encodingtype.cpp**
  - requires:
    - `string != 0 && stream.good()`
    - `true`
  - ensures:
    - `(__out == true) || (__out == false && SEPFORALL(0, strlen("Error: encoding type must be one of [undefined, raw, ber, bdex, xml, json, text or multiparts]\n"), i, stream + stream.tellp() + i ↦ "Error: encoding type must be one of [undefined, raw, ber, bdex, xml, json, text or multiparts]\n"[i]))`
...
- **src/groups/bmq/bmqt/bmqt_messageguid.cpp**
  - requires:
    - `FORALL(0, MessageGUID::e_SIZE_HEX, i, (buffer[i] >= '0' && buffer[i] <= '9') || (buffer[i] >= 'A' && buffer[i] <= 'F'))`
...
- **src/groups/bmq/bmqt/bmqt_version.cpp**
  - requires:
    - `!stream.bad()`
  - ensures:
    - `__out == stream && (stream.bad() || (stream.good() && (SEPFORALL(0, d_major_str.size(), i, stream + i ↦ d_major_str.data()[i]) ⋆ SEPFORALL(0, d_minor_str.size(), j, stream + d_major_str.size() + offset ↦ d_minor_str.data()[j]))))`
...
- **src/groups/bmq/bmqu/bmqu_printutil.cpp**
  - requires:
    ...
    - `groupSize > 0 && (stream.good() || stream.bad())`
    - `groupSize > 0 && stream.good()`
    - `stream.good() && precision >= 0`
    - `true`
  - ensures:
    ...
    - `__out == stream && (stream.bad() || stream.good())`
    - `__out == stream && (stream.good() || stream.bad())`
